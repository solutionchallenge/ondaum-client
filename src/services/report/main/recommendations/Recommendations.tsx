...
function Recommendations() {
    ...
    <Card
      ...
      size="large"
      onClick={() => {
        setMeditationModal({title: '5-Minute Meditation', minutes: 5, videoSrc: '/videos/video_1.mp4', description: 'Practice mindful meditation when feeling anxious. Find a quiet space, sit comfortably, and focus on your breath.', content: `Anxiety Relief`, isVisible: true});
      }}
    />
    <Card
      ...
      size="large"
      onClick={() => {
        setMeditationModal({title: 'Quick Movement Reset', minutes: 10, videoSrc: '/videos/video_2.mp4', description: 'Release built-up anger through mindful movement. Step away from the stress, do light stretches, shake out tension.', content: `Anger Management`, isVisible: true});
